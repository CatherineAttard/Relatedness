...
print "This perl script was written by Catherine Attard\nPlease cite Attard et al. (2016) \"Intra-population genomics: fine-scale structure, adaptation, and relatedness in Australian feeding aggregations of blue whales (Balaenoptera musculus)\" when using this script\nCatherine makes no guarantee that this script is bug-free; use at your own risk and please report bugs to catherine.r.attard\@gmail.com\n";
